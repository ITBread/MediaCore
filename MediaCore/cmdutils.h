 ...
 */
extern void parse_options(void *optctx, int argc, char **argv, const OptionDef *options,
 ...
 */
extern int parse_option(void *optctx, const char *opt, const char *arg,
 ...
 */
extern int parse_optgroup(void *optctx, OptionGroup *g);
 ...
 */
extern int split_commandline(OptionParseContext *octx, int argc, char *argv[],
                      const OptionDef *options,
 ...
 */
extern void uninit_parse_context(OptionParseContext *octx);

/**
 * Find the '-loglevel' option in the command line args and apply it.
 */
extern void parse_loglevel(int argc, char **argv, const OptionDef *options);

/**
 * Return index of option opt in argv or 0 if not found.
 */
extern int locate_option(int argc, char **argv, const OptionDef *options,
                  const char *optname);
 ...
 * the program.
 */
extern void show_banner(int argc, char **argv, const OptionDef *options);
 ...
 */
extern int show_version(void *optctx, const char *opt, const char *arg);
 ...
 * This option processing function does not utilize the arguments.
 */
extern int show_buildconf(void *optctx, const char *opt, const char *arg);
