                         ...
                         const char *arg)
{
	...
	l->groups = ( OptionGroup *)grow_array(l->groups,  l->nb_groups, & l->nb_groups,  l->nb_groups + 1);
                    ...
                    const char *key, const char *val)
{
	...
	g->opts = (  Option  *)grow_array(g->opts,g->nb_opts, &g->nb_opts, g->nb_opts + 1);
...
//static void expand_filename_template(AVBPrint *bp, const char *templatearg,
//                                     struct tm *tm)
//{
//    int c;
//
...
//    av_free((void*)filename_template);
